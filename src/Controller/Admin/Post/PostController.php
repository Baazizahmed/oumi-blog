...
final class PostController extends AbstractController
{
    ...
    {
        $posts = $this->postReposit->findAll();
    ...
    public function create(Request $request): Response
    {
        ...
        $form = $this->createForm(AdminPostForm::class, $post);
    ...
    public function delete(Post $post, Request $request): Response
    {
        if ($this->isCsrfTokenValid("delete-post-{$post->getId()}", $request->request->get('csrf_token'))) {
            ...
            $this->addFlash('success', "L'article a été suprimé");
        }
    ...
    public function publish(Post $post, Request $request): Response
    {
        ...
        if ($post->isPublished()) {
            ...
            $this->addFlash('success', 'cet article a été retiré de la liste des publication');
        } else {
