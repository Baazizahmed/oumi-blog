...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('plantes-du-monde@gmail.com', 'Oumi'))
                    ->to((string) $user->getEmail())
                    ->subject('Vérification de votre compte sur le blog de Oumi')
    ...
    #[Route('/inscription/en-attente-de-la-verification-devotre-compte', name: 'app_register_waiting_for_email_verification', methods: ['GET'])]
